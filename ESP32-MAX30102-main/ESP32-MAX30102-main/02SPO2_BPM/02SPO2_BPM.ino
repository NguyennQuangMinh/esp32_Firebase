...
//Các biến dùng để tính nhịp tim
const byte RATE_SIZE = 4; 
byte rates[RATE_SIZE]; // mảng nhịp tim
byte rateSpot = 0;
long lastBeat = 0; 
float beatsPerMinute;// Thời điểm nhịp cuối cùng xảy ra
int beatAvg;

//Các biến dùng để tính lượng oxy trong máu
double avered = 0;
double aveir = 0;
double sumirrms = 0;
double sumredrms = 0;
